...
void App::drawHelp() {
    ...
    static const Line text[] = {
        ...
        {"", ""},
        {"Windows port and editor: DarkSoL (aka Kufterin, discord: darksol41), with the help and support of Claude AI",
         "Порт для Windows и редактор: DarkSoL (aka Kufterin, discord: darksol41), с помощью и поддержкой ИИ Claude"},
